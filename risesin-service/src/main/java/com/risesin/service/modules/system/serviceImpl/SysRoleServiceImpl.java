 ...
 */
@Service
public class SysRoleServiceImpl extends SingletonParent implements BaseInterface<SysRole> {
     ...
     * @param value
     */
    public void add(SysRole value) {
        sysRoleDao.save(value);
    }
     ...
     * @param value
     */
    public void update(SysRole value) {
        sysRoleDao.save(value);
    }
