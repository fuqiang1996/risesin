...
import com.risesin.service_api.dao.sysuser.SysRoleMenuDao;
...
/**
 * SysRoleMenu的服务接口的实现类
 *
 * @author honey
 */
@Service
public class SysRoleMenuServiceImpl extends SingletonParent implements BaseInterface<SysRoleMenu> {
     ...
     * @param value
     */
    public void add(SysRoleMenu value) {
        sysRoleMenuDao.save(value);
    }
     ...
     * @param value
     */
    public void update(SysRoleMenu value) {
        sysRoleMenuDao.save(value);
    }
