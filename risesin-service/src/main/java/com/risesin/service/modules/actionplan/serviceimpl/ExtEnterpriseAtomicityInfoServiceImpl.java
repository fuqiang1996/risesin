...
import com.risesin.service_api.dao.actionPlan.ExtEnterpriseAtomicityInfoDao;
...
/**
 * ExtEnterpriseAtomicityInfo的服务接口的实现类
 *
 * @author honey
 */
@Service
public class ExtEnterpriseAtomicityInfoServiceImpl extends SingletonParent implements BaseInterface<ExtEnterpriseAtomicityInfo> {
    private final Logger LOG = LogManager.getLogger(this.getClass());

    @Autowired
    private ExtEnterpriseAtomicityInfoDao extEnterpriseAtomicityInfoDao;
     ...
     * @return
     */
    public List<ExtEnterpriseAtomicityInfo> findAll() {
        return extEnterpriseAtomicityInfoDao.findAll();
    }
     ...
     * @return
     */
    public Page<ExtEnterpriseAtomicityInfo> findSearch(Map whereMap, int page, int size) {
        Specification<ExtEnterpriseAtomicityInfo> specification = createSpecification(whereMap);
        PageRequest pageRequest = PageRequest.of(page - 1, size);
        return extEnterpriseAtomicityInfoDao.findAll(specification, pageRequest);
    }
     ...
     * @return
     */
    public List<ExtEnterpriseAtomicityInfo> findSearch(Map whereMap) {
        Specification<ExtEnterpriseAtomicityInfo> specification = createSpecification(whereMap);
        return extEnterpriseAtomicityInfoDao.findAll(specification);
    }
     ...
     * @param value
     */
    public void add(ExtEnterpriseAtomicityInfo value) {
        extEnterpriseAtomicityInfoDao.save(value);
    }
     ...
     * @param value
     */
    public void update(ExtEnterpriseAtomicityInfo value) {
        extEnterpriseAtomicityInfoDao.save(value);
    }
     ...
     * @return
     */
    private Specification<ExtEnterpriseAtomicityInfo> createSpecification(Map searchMap) {

        return new Specification<ExtEnterpriseAtomicityInfo>() {

            @Override
            public Predicate toPredicate(Root<ExtEnterpriseAtomicityInfo> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
                List
