...
import com.risesin.service_api.dao.comuser.ComDeptDao;
 ...
 */
@Service
public class ComDeptServiceImpl extends SingletonParent implements BaseInterface {
     ...
     * @return
     */
    public ComDept findById(Long id) {
        return comDeptDao.findById(id).get();
    }
     ...
     * @param value
     */
    public void add(ComDept value) {
        comDeptDao.save(value);
    }
     ...
     * @param value
     */
    public void update(ComDept value) {
        comDeptDao.save(value);
    }
