package com.risesin.service.modules.entuser.serviceImpl;
...
import com.risesin.service_api.dao.entuser.EnterpriseUserDao;
...
/**
 * EnterpriseUser的服务接口的实现类
 *
 * @author honey
 */
@Service
public class EnterpriseUserServiceImpl extends SingletonParent implements BaseInterface<EnterpriseUser> {
     ...
     * @return
     */
    public EnterpriseUser findById(Long id) {
        return enterpriseUserDao.findById(id).get();
    }
     ...
     * @param value
     */
    public void add(EnterpriseUser value) {
        enterpriseUserDao.save(value);
    }
     ...
     * @param value
     */
    public void update(EnterpriseUser value) {
        enterpriseUserDao.save(value);
    }
    ...
    public void deleteById(Long id) {
        enterpriseUserDao.deleteById(id);
    }
