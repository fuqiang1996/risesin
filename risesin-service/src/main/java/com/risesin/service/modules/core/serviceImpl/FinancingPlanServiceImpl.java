 ...
 */
@Service
public class FinancingPlanServiceImpl extends SingletonParent implements BaseInterface<FinancingPlan> {
     ...
     * @return
     */
    public List<FinancingPlan> findByDelFlagAndCommonUserId(Long delFlag, Long commonUserId) {
//        return planDao.findByDelFlagAndCommonUserId(delFlag, commonUserId);
        return null;
    }
