...
import com.risesin.service_api.dao.servicePack.SmsPackageDao;
 ...
 */
@Service
public class SmsPackageServiceImpl extends SingletonParent implements BaseInterface<SmsPackage> {
     ...
     * @return
     */
    public Page<SmsPackage> findSearch(Map whereMap, int page, int size) {
        Specification<SmsPackage> specification = createSpecification(whereMap);
        PageRequest pageRequest = PageRequest.of(page - 1, size);
        return smsPackageDao.findAll(specification, pageRequest);
    }
     ...
     * @return
     */
    public List<SmsPackage> findSearch(Map whereMap) {
        Specification<SmsPackage> specification = createSpecification(whereMap);
        return smsPackageDao.findAll(specification);
    }
     ...
     * @return
     */
    public SmsPackage findById(Long id) {
     ...
     * @param value
     */
    public void add(SmsPackage value) {
        smsPackageDao.save(value);
    }
     ...
     * @param value
     */
    public void update(SmsPackage value) {
        smsPackageDao.save(value);
    }
     ...
     * @return
     */
    private Specification<SmsPackage> createSpecification(Map searchMap) {

        return new Specification<SmsPackage>() {

            @Override
            public Predicate toPredicate(Root<SmsPackage> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
                List
