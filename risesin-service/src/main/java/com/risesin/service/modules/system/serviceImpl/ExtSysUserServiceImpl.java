...
public class ExtSysUserServiceImpl implements TopInterface {
    ...
    @Autowired
    private ExtSysUserDao extSysUserDao;
     ...
     * @return
     */
    public List<ExtSysUser> findAll() {
        return extSysUserDao.findAll();
    }
     ...
     * @return
     */
    public Page<ExtSysUser> findSearch(Map whereMap, int page, int size) {
        Specification<ExtSysUser> specification = createSpecification(whereMap);
        PageRequest pageRequest = PageRequest.of(page - 1, size);
        return extSysUserDao.findAll(specification, pageRequest);
    }
     ...
     * @return
     */
    public List<ExtSysUser> findSearch(Map whereMap) {
        Specification<ExtSysUser> specification = createSpecification(whereMap);
        return extSysUserDao.findAll(specification);
    }
     ...
     * @return
     */
    public ExtSysUser findById(Long id) {
     ...
     * @param value
     */
    public void add(ExtSysUser value) {
        extSysUserDao.save(value);
    }
     ...
     * @param value
     */
    public void update(ExtSysUser value) {
        extSysUserDao.save(value);
    }
     ...
     * @return
     */
    private Specification<ExtSysUser> createSpecification(Map searchMap) {

        return new Specification<ExtSysUser>() {

            @Override
            public Predicate toPredicate(Root<ExtSysUser> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
                List
