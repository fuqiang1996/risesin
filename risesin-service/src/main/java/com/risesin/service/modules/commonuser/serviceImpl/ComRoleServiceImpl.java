...
import com.risesin.service_api.dao.comuser.ComRoleDao;
 ...
 */
@Service
public class ComRoleServiceImpl  extends SingletonParent implements BaseInterface {
    ...
    public ComRole findById(Long id) {
        return comRoleDao.findById(id).get();
    }
     ...
     * @param value
     */
    public void add(ComRole value) {
        comRoleDao.save(value);
    }
     ...
     * @param value
     */
    public void update(ComRole value) {
        comRoleDao.save(value);
    }
