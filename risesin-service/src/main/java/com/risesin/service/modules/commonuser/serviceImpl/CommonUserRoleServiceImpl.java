...
/**
 * CommonUserRole的服务接口的实现类
 *
 * @author honey
 */
@Service
public class CommonUserRoleServiceImpl {
    private final Logger LOG = LogManager.getLogger(this.getClass());

    @Autowired
    private CommonUserRoleDao commonUserRoleDao;
     ...
     * @return
     */
    public List<CommonUserRole> findAll() {
        return commonUserRoleDao.findAll();
    }
     ...
     * @return
     */
    public Page<CommonUserRole> findSearch(Map whereMap, int page, int size) {
        Specification<CommonUserRole> specification = createSpecification(whereMap);
        PageRequest pageRequest = PageRequest.of(page - 1, size);
        return commonUserRoleDao.findAll(specification, pageRequest);
    }
     ...
     * @return
     */
    public List<CommonUserRole> findSearch(Map whereMap) {
        Specification<CommonUserRole> specification = createSpecification(whereMap);
        return commonUserRoleDao.findAll(specification);
    }
     ...
     * @return
     */
    public CommonUserRole findById(Long id) {
        return commonUserRoleDao.findById(id).get();
    }
     ...
     * @param value
     */
    public void add(CommonUserRole value) {
        commonUserRoleDao.save(value);
    }
     ...
     * @param value
     */
    public void update(CommonUserRole value) {
        commonUserRoleDao.save(value);
    }
    ...
    public void deleteById(Long id) {
        commonUserRoleDao.deleteById(id);
    }
     ...
     * @return
     */
    private Specification<CommonUserRole> createSpecification(Map searchMap) {

        return new Specification<CommonUserRole>() {

            @Override
            public Predicate toPredicate(Root<CommonUserRole> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
                List
