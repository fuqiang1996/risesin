...
import com.risesin.service_api.dao.comuser.ComBranchCompanyDao;
...
/**
 * ComBranchCompany的服务接口的实现类
 *
 * @author honey
 */
@Service
public class ComBranchCompanyServiceImpl extends SingletonParent implements BaseInterface {
    private final Logger LOG = LogManager.getLogger(this.getClass());

    @Autowired
    private ComBranchCompanyDao comBranchCompanyDao;
     ...
     * @return
     */
    public List<ComBranchCompany> findAll() {
        return comBranchCompanyDao.findAll();
    }
     ...
     * @return
     */
    public Page<ComBranchCompany> findSearch(Map whereMap, int page, int size) {
        Specification<ComBranchCompany> specification = createSpecification(whereMap);
        PageRequest pageRequest = PageRequest.of(page - 1, size);
        return comBranchCompanyDao.findAll(specification, pageRequest);
    }
     ...
     * @return
     */
    public List<ComBranchCompany> findSearch(Map whereMap) {
        Specification<ComBranchCompany> specification = createSpecification(whereMap);
        return comBranchCompanyDao.findAll(specification);
    }
     ...
     * @return
     */
    public ComBranchCompany findById(Long id) {
        return comBranchCompanyDao.findById(id).get();
    }
     ...
     * @param value
     */
    public void add(ComBranchCompany value) {
        comBranchCompanyDao.save(value);
    }
     ...
     * @param value
     */
    public void update(ComBranchCompany value) {
        comBranchCompanyDao.save(value);
    }
    ...
    public void deleteById(Long id) {
        comBranchCompanyDao.deleteById(id);
    }
     ...
     * @return
     */
    private Specification<ComBranchCompany> createSpecification(Map searchMap) {

        return new Specification<ComBranchCompany>() {

            @Override
            public Predicate toPredicate(Root<ComBranchCompany> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
                List
