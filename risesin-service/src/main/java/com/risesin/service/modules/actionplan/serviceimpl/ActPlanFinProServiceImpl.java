 ...
 */
@Service
public class ActPlanFinProServiceImpl extends SingletonParent implements BaseInterface<ActPlanFinPro> {
     ...
     * @return
     */
    public List<ActPlanFinPro> findAll() {
        return actPlanFinProDao.findAll();
    }
     ...
     * @return
     */
    public Page<ActPlanFinPro> findSearch(Map whereMap, int page, int size) {
        Specification<ActPlanFinPro> specification = createSpecification(whereMap);
        PageRequest pageRequest = PageRequest.of(page - 1, size);
        return actPlanFinProDao.findAll(specification, pageRequest);
    }
     ...
     * @return
     */
    public List<ActPlanFinPro> findSearch(Map whereMap) {
        Specification<ActPlanFinPro> specification = createSpecification(whereMap);
        return actPlanFinProDao.findAll(specification);
    }
     ...
     * @return
     */
    public ActPlanFinPro findById(Long id) {
     ...
     * @param value
     */
    public void add(ActPlanFinPro value) {
        actPlanFinProDao.save(value);
    }
     ...
     * @param value
     */
    public void update(ActPlanFinPro value) {
        actPlanFinProDao.save(value);
    }
     ...
     * @return
     */
    private Specification<ActPlanFinPro> createSpecification(Map searchMap) {

        return new Specification<ActPlanFinPro>() {

            @Override
            public Predicate toPredicate(Root<ActPlanFinPro> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
                List
