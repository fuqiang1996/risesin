...
import com.risesin.service_api.dao.comuser.ComRoleMenuDao;
...
/**
 * ComRoleMenu的服务接口的实现类
 *
 * @author honey
 */
@Service
public class ComRoleMenuServiceImpl  extends SingletonParent implements BaseInterface {
     ...
     * @return
     */
    public ComRoleMenu findById(Long id) {
        return comRoleMenuDao.findById(id).get();
    }
     ...
     * @param value
     */
    public void add(ComRoleMenu value) {
        comRoleMenuDao.save(value);
    }
     ...
     * @param value
     */
    public void update(ComRoleMenu value) {
        comRoleMenuDao.save(value);
    }
