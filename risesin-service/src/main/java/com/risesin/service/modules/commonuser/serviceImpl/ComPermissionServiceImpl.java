...
import com.risesin.service_api.dao.comuser.ComPermissionDao;
...
/**
 * ComPermission的服务接口的实现类
 *
 * @author honey
 */
@Service
public class ComPermissionServiceImpl extends SingletonParent implements BaseInterface {
     ...
     * @return
     */
    public ComPermission findById(Long id) {
        return comPermissionDao.findById(id).get();
    }
     ...
     * @param value
     */
    public void add(ComPermission value) {
        comPermissionDao.save(value);
    }
     ...
     * @param value
     */
    public void update(ComPermission value) {
        comPermissionDao.save(value);
    }
    ...
    public void deleteById(Long id) {
        comPermissionDao.deleteById(id);
    }
