...
/**
 * SysUserRole的服务接口的实现类
 *
 * @author honey
 */
@Service
public class SysUserRoleServiceImpl implements TopInterface<SysUserRole> {
     ...
     * @param value
     */
    public void add(SysUserRole value) {
        sysUserRoleDao.save(value);
    }
     ...
     * @param value
     */
    public void update(SysUserRole value) {
        sysUserRoleDao.save(value);
    }
